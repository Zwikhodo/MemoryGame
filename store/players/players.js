...
export const usePlayerStore = create((set) => ({
  ...
  updateWinner : (value)=> set((state)  =>  ({
    winner : value
  })), 
  setPlayer1Name:   (value) => set((state)  =>  ({
    player1:  {...state.player1,playerName:value}
  })),
  setPlayer2Name:   (value) => set((state)  =>  ({
    player2:  {...state.player2,playerName:value}
  })),
  setPlayer1Score:   (value) => set((state)  =>  ({
    player1Score:  {...state.player1,score:value}
  })),
  setPlayer2Score:   (value) => set((state)  =>  ({
